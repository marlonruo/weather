...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/casapngcopy.png", id:"casapngcopy"}
	]
};
...
(lib.casapngcopy = function() {
	this.initialize(img.casapngcopy);
}).prototype = p = new cjs.Bitmap();
...
// stage content:
(lib._301n = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// fondo
	this.instance_1 = new lib.casapngcopy();
