...
(lib._800n = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// estrellas
	this.instance = new lib.estrella_2_anima("synched",4);
	this.instance.setTransform(94,65,1,1,0,0,0,6,6);
	this.instance.alpha = 0.398;

	this.instance_1 = new lib.estrella_2_anima("synched",0);
	this.instance_1.setTransform(270,31,1,1,0,0,0,6,6);
	this.instance_1.alpha = 0.102;

	this.instance_2 = new lib.estrella_2_anima("synched",0);
	this.instance_2.setTransform(697,344,1,1,0,0,0,6,6);
	this.instance_2.alpha = 0.102;

	this.instance_3 = new lib.estrella_2_anima("synched",0);
	this.instance_3.setTransform(112,228,1,1,0,0,0,6,6);
	this.instance_3.alpha = 0.102;

	this.instance_4 = new lib.estrella_1_anima("synched",4);
	this.instance_4.setTransform(382.1,34.5,1,1,0,0,0,4.5,4.5);
	this.instance_4.alpha = 0.148;

	this.instance_5 = new lib.estrella_1_anima("synched",1);
	this.instance_5.setTransform(83.5,469.5,1,1,0,0,0,4.5,4.5);
	this.instance_5.alpha = 0.051;

	this.instance_6 = new lib.estrella_1_anima("synched",0);
	this.instance_6.setTransform(256.5,434.5,1,1,0,0,0,4.5,4.5);
	this.instance_6.alpha = 0.051;

	this.instance_7 = new lib.estrella_1_anima("synched",3);
	this.instance_7.setTransform(101.5,405.5,1,1,0,0,0,4.5,4.5);
	this.instance_7.alpha = 0.051;

	this.instance_8 = new lib.estrella_1_anima("synched",4);
	this.instance_8.setTransform(506.1,184.6,1,1,0,0,0,4.5,4.5);
	this.instance_8.alpha = 0.199;

	this.instance_9 = new lib.estrella_1_anima("synched",4);
	this.instance_9.setTransform(698.5,38.5,1,1,0,0,0,4.5,4.5);
	this.instance_9.alpha = 0.25;

	this.instance_10 = new lib.estrella_1_anima("synched",4);
	this.instance_10.setTransform(658.1,169.5,1,1,0,0,0,4.5,4.5);
	this.instance_10.alpha = 0.148;

	this.instance_11 = new lib.estrella_1_anima("synched",0);
	this.instance_11.setTransform(539.1,38.5,1,1,0,0,0,4.5,4.5);
	this.instance_11.alpha = 0.25;

	this.instance_12 = new lib.estrella_1_anima("synched",2);
	this.instance_12.setTransform(460.6,96.5,1,1,0,0,0,4.5,4.5);
	this.instance_12.alpha = 0.148;

	this.instance_13 = new lib.estrella_1_anima("synched",0);
	this.instance_13.setTransform(613.1,318.5,1,1,0,0,0,4.5,4.5);
	this.instance_13.alpha = 0.102;

	this.instance_14 = new lib.estrella_1_anima("synched",4);
	this.instance_14.setTransform(493.5,399.5,1,1,0,0,0,4.5,4.5);
	this.instance_14.alpha = 0.051;

	this.instance_15 = new lib.estrella_1_anima("synched",0);
	this.instance_15.setTransform(696,416.5,1,1,0,0,0,4.5,4.5);
	this.instance_15.alpha = 0.051;

	this.instance_16 = new lib.estrella_1_anima("synched",2);
	this.instance_16.setTransform(486.6,342.5,1,1,0,0,0,4.5,4.5);
	this.instance_16.alpha = 0.102;

	this.instance_17 = new lib.estrella_1_anima("synched",1);
	this.instance_17.setTransform(577.1,399.5,1,1,0,0,0,4.5,4.5);
	this.instance_17.alpha = 0.051;

	this.instance_18 = new lib.estrella_1_anima("synched",0);
	this.instance_18.setTransform(188.5,29.5,1,1,0,0,0,4.5,4.5);
	this.instance_18.alpha = 0.25;

	this.instance_19 = new lib.estrella_1_anima("synched",4);
	this.instance_19.setTransform(74.5,136.5,1,1,0,0,0,4.5,4.5);
	this.instance_19.alpha = 0.148;

	this.instance_20 = new lib.estrella_1_anima("synched",0);
	this.instance_20.setTransform(271.5,127.5,1,1,0,0,0,4.5,4.5);
	this.instance_20.alpha = 0.148;

	this.instance_21 = new lib.estrella_1_anima("synched",2);
	this.instance_21.setTransform(65.5,334.5,1,1,0,0,0,4.5,4.5);
	this.instance_21.alpha = 0.102;

	this.instance_22 = new lib.estrella_1_anima("synched",3);
	this.instance_22.setTransform(143.6,300.5,1,1,0,0,0,4.5,4.5);
	this.instance_22.alpha = 0.102;

	this.instance_23 = new lib.estrella_1_anima("synched",1);
	this.instance_23.setTransform(152.6,110.5,1,1,0,0,0,4.5,4.5);
	this.instance_23.alpha = 0.148;

	this.instance_24 = new lib.estrella_2_anima("synched",0);
	this.instance_24.setTransform(638.5,100,1,1,0,0,0,6,6);
	...
	// bicicleta.png
	this.instance_25 = new lib.bicicleta_1("synched",0);
	this.instance_25.setTransform(80.1,311,1,1,0,0,0,54,45);

	this.timeline.addTween(cjs.Tween.get(this.instance_25).wait(100));

	// luna.png
	this.instance_26 = new lib.luna();
	this.instance_26.setTransform(271,113);

	this.timeline.addTween(cjs.Tween.get(this.instance_26).wait(100));

	// brillo
	this.instance_27 = new lib.brillo_anima("synched",0);
	this.instance_27.setTransform(374.5,219.5,1,1,0,0,0,190.5,190.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_27).wait(100));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = rect = new cjs.Rectangle(401.1,295,677,449);
p.frameBounds = [rect, new cjs.Rectangle(432.9,295,645.2,449), rect=new cjs.Rectangle(436,295,642,449), rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, new cjs.Rectangle(436,295,660,449), rect=new cjs.Rectangle(436,295,642,449), rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect];
