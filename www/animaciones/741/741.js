...
p.nominalBounds = new cjs.Rectangle(0,0,225,138);
...
(lib.wagon = function(mode,startPosition,loop) {
...
p.nominalBounds = rect = new cjs.Rectangle(0,0,225,138);
...
// stage content:
(lib._741 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// fondo
	this.instance_2 = new lib.wagon("synched",0);
	this.instance_2.setTransform(381.5,471,1,1,0,0,0,112.5,69);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(72));

	// humo
	this.instance_3 = new lib.humo2("synched",35);
	this.instance_3.setTransform(375,311,1,1,0,0,0,375,270);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(72));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = rect = new cjs.Rectangle(375,270,750,581);
